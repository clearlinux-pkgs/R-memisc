...
Version  : 0.99.17.1
Release  : 20
URL      : https://cran.r-project.org/src/contrib/memisc_0.99.17.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/memisc_0.99.17.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1552951289
