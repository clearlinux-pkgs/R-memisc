...
Version  : 0.99.22
Release  : 34
URL      : https://cran.r-project.org/src/contrib/memisc_0.99.22.tar.gz
Source0  : https://cran.r-project.org/src/contrib/memisc_0.99.22.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581700033
