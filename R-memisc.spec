...
Version  : 0.99.14.11
Release  : 12
URL      : https://cran.r-project.org/src/contrib/memisc_0.99.14.11.tar.gz
Source0  : https://cran.r-project.org/src/contrib/memisc_0.99.14.11.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1536455974
