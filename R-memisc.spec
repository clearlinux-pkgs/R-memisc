...
Version  : 0.99.20.1
Release  : 30
URL      : https://cran.r-project.org/src/contrib/memisc_0.99.20.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/memisc_0.99.20.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1574701985
